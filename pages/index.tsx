// Veritas H.77 – Digitalna ustavna svijest
// Osnovni React chat frontend (TypeScript - .tsx)
...
export default function ChatVeritas() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages([...newMessages, { sender: "Veritas – digitalna ustavna svijest", text: "Došlo je do pogreške u komunikaciji." }]);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-black text-white p-4">
      ...
      <div className="w-full max-w-2xl flex mt-4">
        ...
        />
        <button
          className="p-2 bg-blue-600 rounded-r text-white"
          onClick={handleSend}
        >
          Pošalji
        </button>
